...
public class SerieController {
	...
	public String addNewSerieConfirmation(@ModelAttribute Serie serie, @ModelAttribute("action") String action, Model model) {
		if (action.equals("edit"))
			serienService.updateSerie(serie);
		else
			serienService.saveSerie(serie);
